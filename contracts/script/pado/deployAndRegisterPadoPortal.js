...
async function main() {
    ...
    const RouterAddressTestnet = "0x736c78b2f2cBf4F921E8551b2acB6A5Edc9177D5";
    //const RouterAddressMainnet = "0x4d3a380A03f3a18A5dC44b01119839D8674a552E";
    ...
    const padoportal = await hre.upgrades.deployProxy(padoportalcontract,
        ["PADO Portal", fee, receiveAddr, [], RouterAddressTestnet], {initializer: 'initialize'});
    ...
    const PortalRegistryTestnet = "0x506f88a5Ca8D5F001f2909b029738A40042e42a6";
    //const PortalRegistryMainnet = "0xd5d61e4ECDf6d46A63BfdC262af92544DFc19083";
    const contract = await hre.ethers.getContractAt("PortalRegistry", PortalRegistryTestnet);
    try {
